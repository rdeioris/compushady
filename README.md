...
You can write shaders in HLSL and they will be compiled into the appropriate format (DXIL, DXBC, SPIR-V, ...) automatically (using the DXC compiler included in the module).
...
If you are looking for something cool, try the naive pong implementation: https://github.com/rdeioris/compushady/blob/main/examples/pong.py
